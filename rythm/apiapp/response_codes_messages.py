...
POST_LIKE_MISSING_FIELDS_MESSAGE = 'The challenge is not active'
...
POST_UNLIKE_MISSING_FIELDS_MESSAGE = 'The challenge is not active'
...
POST_DELETE_COMMENT_NOT_AUTHORISED_MESSAGE = 'User is not authorised to delete post'
